...
class Trainer:
    def __init__(self, cfg: DictConfig) -> None:
        ...
        if not cfg.common.resume:
            ...
            shutil.copytree(src=(Path(hydra.utils.get_original_cwd()) / "ATML-Project/src"), dst="./src")
            shutil.copytree(src=(Path(hydra.utils.get_original_cwd()) / "ATML-Project/scripts"), dst="./scripts")
